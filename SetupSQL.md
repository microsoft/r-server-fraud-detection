...
6.	Now, click on <code>File</code> on the top left corner of the SQL Server window and select <code>Connect Object Explorer…</code> verify that you can connect to the server with the username you just created.
...
1. Download the [install_server.R](https://github.com/Microsoft/r-server-fraud-detection/blob/master/R/install_server.R) file.
